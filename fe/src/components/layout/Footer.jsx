      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              <span className="text-2xl font-bold text-primary-400">IT Jobs</span>
            </div>
            <p className="text-gray-300 mb-4">
              Nền tảng tuyển dụng hàng đầu cho ngành Công nghệ Thông tin tại Việt Nam.
              Kết nối ứng viên tài năng với các cơ hội việc làm IT tốt nhất.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/companies" className="text-gray-300 hover:text-primary-400 transition-colors">
                  Công ty
                </Link>
              </li>
              <li>
                <Link to="/salary" className="text-gray-300 hover:text-primary-400 transition-colors">
                  Báo cáo lương
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-300 text-sm">
            © 2024 IT Jobs Platform. Tất cả quyền được bảo lưu.
          </p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            ...
            <Link to="/cookies" className="text-gray-300 hover:text-primary-400 text-sm transition-colors">
              Chính sách Cookie
            </Link>
          </div>
        </div>
